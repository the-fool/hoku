...
var _user$project$Main$changeRhythmWSMsg = F2(
	function (index, rhythm) {
		var value = function () {
			var _p0 = rhythm;
			switch (_p0.ctor) {
				case 'Legato':
		...
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'kind',
					_1: _elm_lang$core$Json_Encode$string('rhythm')
				},
				_1: {
					ctor: '::',
					_0: {
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'index',
									_1: _elm_lang$core$Json_Encode$int(index)
								},
								_1: {
									ctor: '::',
									_0: {
...
var _user$project$Main$numPitches = 4;
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {rhythm: a, wsurl: b};
	});
var _user$project$Main$init = function (fs) {
	var getStateWSMsg = _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'kind',
				_1: _elm_lang$core$Json_Encode$string('state')
			},
			_1: {ctor: '[]'}
		});
	...
	return {
		...
		_1: A2(
			...
			wsurl,
			A2(_elm_lang$core$Json_Encode$encode, 0, getStateWSMsg))
	};
};
var _user$project$Main$StateMsgPayload = F2(
	function (a, b) {
		return {pitches: a, rhythm: b};
	});
var _user$project$Main$StateMsg = function (a) {
	return {payload: a};
};
...
var _user$project$Main$decodeBeatMsg = function () {
	var payloadDecoder = A3(
		...
		A3(
			...
			'rhythm_index',
			_elm_lang$core$Json_Decode$int,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$BeatMsgPayload)));
	return A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'payload',
		payloadDecoder,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$BeatMsg));
}();
var _user$project$Main$Beat = function (a) {
	return {ctor: 'Beat', _0: a};
};
var _user$project$Main$Legato = {ctor: 'Legato'};
var _user$project$Main$Rest = {ctor: 'Rest'};
var _user$project$Main$intToRhythm = function (i) {
	return _elm_lang$core$Native_Utils.eq(i, -1) ? _user$project$Main$Rest : (_elm_lang$core$Native_Utils.eq(i, 0) ? _user$project$Main$Legato : _user$project$Main$Beat(i - 1));
};
var _user$project$Main$updateState = function (msg) {
	var payloadDecoder = A3(
		...
		A3(
			...
			'pitches',
			_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$int),
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$StateMsgPayload)));
	var stateMsgDecoder = A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'payload',
		payloadDecoder,
	...
	var updater = F2(
		function (newState, model) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					rhythm: A2(_elm_lang$core$List$map, _user$project$Main$intToRhythm, newState.payload.rhythm)
				});
		});
	var _p1 = A2(_elm_lang$core$Json_Decode$decodeString, stateMsgDecoder, msg);
	if (_p1.ctor === 'Ok') {
		return updater(_p1._0);
	} else {
		...
		do {
			if (_p3.ctor === 'Ok') {
				switch (_p3._0) {
					...
					case 'beat':
						var cmd = function () {
							var _p4 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$decodeBeatMsg, wsmsg);
							if (_p4.ctor === 'Ok') {
								return _user$project$Main$beat(_p4._0.payload.rhythmIndex);
							} else {
								return _elm_lang$core$Native_Utils.crashCase(
									'Main',
									{
										start: {line: 138, column: 21},
										end: {line: 143, column: 62}
									},
									_p4)('error decoding beat');
							}
						}();
		...
		if (_p6.ctor === 'RcvMsg') {
			...
			var cmd = A2(
				...
				A2(
					...
					0,
					A2(_user$project$Main$changeRhythmWSMsg, _p7, _p8)));
			var setRhythm = F2(
				function (i, currentRhythm) {
					return _elm_lang$core$Native_Utils.eq(i, _p7) ? _p8 : currentRhythm;
				});
			var newRhythms = _elm_lang$core$List$indexedMap(setRhythm);
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						rhythm: newRhythms(model.rhythm)
					}),
				_1: cmd
			};
		}
	});
var _user$project$Main$SetRhythm = F2(
	function (a, b) {
		return {ctor: 'SetRhythm', _0: a, _1: b};
	});
var _user$project$Main$viewRhythmBox = F2(
	function (i, rhythm) {
		var colorClass = function (r) {
			var _p9 = r;
			switch (_p9.ctor) {
				case 'Rest':
					return 'rest';
				...
				_elm_lang$html$Html$div,
				{
					...
					_0: _elm_lang$html$Html_Attributes$class(
						A2(
							...
							'swatch ',
							colorClass(
								_user$project$Main$intToRhythm(j)))),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							A2(
								_user$project$Main$SetRhythm,
								i,
								_user$project$Main$Beat(j))),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'});
		...
		var palette = A2(
			...
			_elm_lang$core$List$reverse(
				A2(_elm_lang$core$List$range, -1, _user$project$Main$numPitches)));
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('rhythm-box-container'),
				_1: {
					ctor: '::',
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('mini-palette'),
							_1: {ctor: '[]'}
						},
						palette),
					_1: {ctor: '[]'}
...
var _user$project$Main$viewRhythms = function (rhythms) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('rhythm-container'),
			_1: {ctor: '[]'}
		},
		A2(_elm_lang$core$List$indexedMap, _user$project$Main$viewRhythmBox, rhythms));
};
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$viewRhythms(model.rhythm),
			_1: {ctor: '[]'}
		});
};
