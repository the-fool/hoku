...
var _user$project$Main$changePitchWSMsg = F2(
		...
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'kind',
					_1: _elm_lang$core$Json_Encode$string('pitch')
				},
				_1: {
					ctor: '::',
					_0: {
...
var _user$project$Main$updateNotes = F3(
...
var _user$project$Main$decodeStateMsg = function () {
	var payloadDecoder = A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'rhythm',
...
var _user$project$Main$viewNotes = function (notes) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(_elm_lang$core$List$indexedMap, _user$project$Main$viewNote, notes));
};
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$viewNotes(model.notes),
			_1: {ctor: '[]'}
		});
};
