...
function onmessage(msg) {
  bugData = JSON.parse(msg.data).agents;
}

const fill = bug => 'hsla(' + (bug.vel * 70) % 360 + ',100%,50%,' + Math.max(bug.vel * 0.1, 0.05) + ')';
const stroke = bug => 'hsl(' + (bug.vel * 70) % 360 + ',100%,50%)';
let frameCount = 0;
...
function paintSVG() {
  ...
  bugs.enter()
    ...
    .merge(bugs)
    .attrs({
      transform: b => `translate(${b.x} ${b.y}) rotate(${rotation(b, frameCount)})`,
      stroke: stroke,
      fill: fill
    })
...
const bugSVG = `
  <g>
    <polygon class="st0" points="44,13.8 54.7,18.2 65.4,22.7 69.8,33.4 74.3,44 69.8,54.7 65.4,65.4 54.7,69.8 44,74.3 33.4,69.8 22.7,65.4 18.2,54.7 13.8,44 18.2,33.4 22.7,22.7 33.4,18.2"/>
  </g>
  <g>
    <polygon class="st0" points="44,1.4 54.7,18.2 74.2,13.9 69.8,33.4 86.7,44 69.8,54.7 74.2,74.2 54.7,69.8 44,86.7 33.4,69.8 13.9,74.2 18.2,54.7 1.4,44 18.2,33.4 13.9,13.9 33.4,18.2"/>
    <circle class="st1" cx="33.4" cy="18.2" r="1.4"/>
    <circle class="st1" cx="13.9" cy="13.9" r="1.4"/>
    <circle class="st1" cx="18.2" cy="33.4" r="1.4"/>
    <circle class="st1" cx="1.4" cy="44" r="1.4"/>
    <circle class="st1" cx="18.2" cy="54.7" r="1.4"/>
    <circle class="st1" cx="13.9" cy="74.2" r="1.4"/>
    <circle class="st1" cx="33.4" cy="69.8" r="1.4"/>
    <circle class="st1" cx="44" cy="86.7" r="1.4"/>
    <circle class="st1" cx="54.7" cy="69.8" r="1.4"/>
    <circle class="st1" cx="74.2" cy="74.2" r="1.4"/>
    <circle class="st1" cx="69.8" cy="54.7" r="1.4"/>
    <circle class="st1" cx="86.7" cy="44" r="1.4"/>
    <circle class="st1" cx="69.8" cy="33.4" r="1.4"/>
    <circle class="st1" cx="74.2" cy="13.9" r="1.4"/>
    <circle class="st1" cx="54.7" cy="18.2" r="1.4"/>
    <circle class="st1" cx="44" cy="1.4" r="1.4"/>
  </g>
  <g>
    <polygon class="st0" points="44,31.3 48.5,33.2 53,35 54.9,39.5 56.8,44 54.9,48.5 53,53 48.5,54.9 44,56.8 39.5,54.9 35,53 33.2,48.5 31.3,44 33.2,39.5 35,35 39.5,33.2"/>
    <circle class="st1" cx="50.7" cy="44" r="1.4"/>
    <circle class="st1" cx="44" cy="50.7" r="1.4"/>
    <circle class="st1" cx="37.3" cy="44" r="1.4"/>
    <circle class="st1" cx="44" cy="37.3" r="1.4"/>
  </g>
`
